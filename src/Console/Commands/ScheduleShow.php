...
namespace i8086\SchedulerViewer\Console\Commands;
...
class ScheduleShow extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'schedule:show {--raw : Shows raw output}';
     ...
     * @var string
     */
    protected $description = 'Show scheduled commands';
